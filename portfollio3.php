		   ...
		   <div class="row">
			  			...
			  			<div class="col-xs-6 hidden-sm col-md-3">
			  	  		<div class="codeExample">
			  				<a href="https://github.com/webwolf2112/codeExamples/blob/master/stickySlider.js" target="blank"><img src="/img/postIt.png" alt="Vanessa Henson">
			  				<div class="post-text">
			  					...
			  					<p class="post-bottom">View On Git Hub</p>
			  					</div>
			  				</div>
			  				</a>
			  			</div>
